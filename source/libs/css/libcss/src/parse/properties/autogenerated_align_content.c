		...
		css_style *result)
{
	...
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[STRETCH], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_ALIGN_CONTENT, 0,ALIGN_CONTENT_STRETCH);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[FLEX_START], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_ALIGN_CONTENT, 0,ALIGN_CONTENT_FLEX_START);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[FLEX_END], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_ALIGN_CONTENT, 0,ALIGN_CONTENT_FLEX_END);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[CENTER], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_ALIGN_CONTENT, 0,ALIGN_CONTENT_CENTER);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[SPACE_BETWEEN], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_ALIGN_CONTENT, 0,ALIGN_CONTENT_SPACE_BETWEEN);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[SPACE_AROUND], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_ALIGN_CONTENT, 0,ALIGN_CONTENT_SPACE_AROUND);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[SPACE_EVENLY], &match) == lwc_error_ok && match)) {
