		...
		css_style *result)
{
	...
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[ALWAYS], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_ALWAYS);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[AVOID], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_AVOID);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[LEFT], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_LEFT);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[RIGHT], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_RIGHT);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[PAGE], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_PAGE);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[COLUMN], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_COLUMN);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[AVOID_PAGE], &match) == lwc_error_ok && match)) {
			error = css__stylesheet_style_appendOPV(result, CSS_PROP_BREAK_AFTER, 0,BREAK_AFTER_AVOID_PAGE);
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[AVOID_COLUMN], &match) == lwc_error_ok && match)) {
