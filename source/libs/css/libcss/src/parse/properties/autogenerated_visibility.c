		...
		css_style *result)
{
	...
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[VISIBLE], &match) == lwc_error_ok && match)) {
	...
	} else if ((lwc_string_caseless_isequal(c->sheet->ctx, token->idata, c->strings[COLLAPSE], &match) == lwc_error_ok && match)) {
