 ...
 */
parserutils_error parserutils_charset_codec_create(parserutils_realloc realloc, void* user, const char *charset,
		parserutils_charset_codec **codec)
{
	parserutils_charset_codec *c = 0;
	...
	/* Instantiate class */
	error = (*handler)->create(realloc, user, canon->name, &c);
		...
		parserutils_charset_codec *codec)
{
	...
	codec->handler.realloc(codec, 0, codec->handler.user);
