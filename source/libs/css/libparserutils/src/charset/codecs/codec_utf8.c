...
static parserutils_error charset_utf8_codec_create(parserutils_realloc realloc, void* user, 
 ...
 */
parserutils_error charset_utf8_codec_create(parserutils_realloc realloc, void* user, 
	const char *charset, parserutils_charset_codec **codec)
{
	charset_utf8_codec *c;
	...
	c = realloc(0, sizeof(charset_utf8_codec), user);
	if (c == NULL)
