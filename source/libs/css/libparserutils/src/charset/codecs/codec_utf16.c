...
static parserutils_error charset_utf16_codec_create(parserutils_realloc realloc, void* user, 
 ...
 */
parserutils_error charset_utf16_codec_create(parserutils_realloc realloc, void* user, 
	const char *charset, parserutils_charset_codec **codec)
{
	charset_utf16_codec *c;
	...
	c = realloc(0, sizeof(charset_utf16_codec), user);
	if (c == NULL)
