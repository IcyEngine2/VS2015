...
static parserutils_error charset_8859_codec_create(parserutils_realloc realloc, void* user, 
 ...
 */
parserutils_error charset_8859_codec_create(parserutils_realloc realloc, void* user, 
	const char *charset, parserutils_charset_codec **codec)
{
	uint32_t i;
	charset_8859_codec *c;
	...
	c = realloc(0, sizeof(charset_8859_codec), user);
	if (c == NULL)
