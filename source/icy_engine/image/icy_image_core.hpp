...
struct icy::image::data_type
{
    ...
    data_type(icy::heap& heap) noexcept : heap(heap)
    {
...
extern icy::image::data_type* make_image_png(icy::heap& heap) noexcept;
extern icy::image::data_type* make_image_jpg(icy::heap& heap) noexcept;