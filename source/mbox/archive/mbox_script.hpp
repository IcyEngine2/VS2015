...
{
    template<>
    inline int compare<mbox::type>(const mbox::type& lhs, const mbox::type& rhs) noexcept
    {
        return static_cast<int32_t>(lhs) - static_cast<int32_t>(rhs);
    }
    template<>
    inline int compare<mbox::action_type>(const mbox::action_type& lhs, const mbox::action_type& rhs) noexcept
    {
        return static_cast<int32_t>(lhs) - static_cast<int32_t>(rhs);
    }
}
