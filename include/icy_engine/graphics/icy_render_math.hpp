...
namespace icy
{
	...
	{
		render_vector() noexcept : x(0), y(0), z(0)
		{

		}
		render_vector(const float x, const float y, const float z) noexcept : x(x), y(y), z(z)
		{
	...
	struct render_box
	{
		render_vector center;
		render_vector axis[2];
		render_vector dimensions;
	};
